...
class departamentos{
    ...
    public function insertarDepartamento(){
        try {
            ...
            $this->stmt = $this->conn->prepare($this->sql);
            $this->stmt->bindParam(":department_id", $this->department_id);
            $this->stmt->bindParam(":department_name", $this->department_name);
            $this->stmt->bindParam(":manager_id", $this->manager_id);
            $this->stmt->bindParam(":location_id", $this->location_id);
            $this->stmt->execute();
            $this->bd->cerrar_conexion();
            return true;
        } catch (PDOException $e) {
